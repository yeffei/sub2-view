...
const (
	...
	SettingKeyPaymentRechargeCampaignEnabled   = "payment_recharge_campaign_enabled"    // 充值活动总开关
	SettingKeyPaymentRechargeCampaignAmount    = "payment_recharge_campaign_amount"     // 充值活动触发金额
	SettingKeyPaymentRechargeCampaignBonusRate = "payment_recharge_campaign_bonus_rate" // 充值活动加赠比例（百分比）
	...
	SettingKeyPurchaseSubscriptionURL     = "purchase_subscription_url"     // 前台 /purchase 使用的外部购买链接
	...
	// SettingKeyUpstreamRateSyncEnabled controls the fixed three-times-daily
	// synchronization of API-key account cost multipliers.
	SettingKeyUpstreamRateSyncEnabled = "upstream_rate_sync_enabled"
