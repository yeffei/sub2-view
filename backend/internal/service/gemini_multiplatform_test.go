...
func (m *mockAccountRepoForGemini) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, status, anomalyReason, search string, groupID int64, privacyMode string) ([]Account, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
...
func (m *mockAccountRepoForGemini) GetGroups(ctx context.Context, accountID int64) ([]Group, error) {
	return nil, nil
}
