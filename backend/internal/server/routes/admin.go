...
func RegisterAdminRoutes(
	...
	admin.Use(middleware.AdminComplianceGuard(settingService))
	{
		...
		// 上游池管理
		registerUpstreamPoolRoutes(admin, h)
...
func registerSystemRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	system := admin.Group("/system")
	{
		...
		system.GET("/update/preflight", h.Admin.System.CheckUpdatePreflight)
...
func registerUpstreamPoolRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	pools := admin.Group("/upstream-pools")
	{
		pools.GET("", h.Admin.UpstreamPool.List)
		pools.POST("", h.Admin.UpstreamPool.Create)
		pools.GET("/bindings", h.Admin.UpstreamPool.GetBindings)
		pools.GET("/capacity-pressures", h.Admin.UpstreamPool.GetCapacityPressures)
		pools.GET("/account-sets", h.Admin.UpstreamPool.GetAccountSets)
		pools.POST("/account-sets", h.Admin.UpstreamPool.CreateAccountSet)
		pools.PUT("/account-sets/:set_id", h.Admin.UpstreamPool.UpdateAccountSet)
		pools.DELETE("/account-sets/:set_id", h.Admin.UpstreamPool.DeleteAccountSet)
		pools.GET("/account-sets/:set_id/members", h.Admin.UpstreamPool.GetAccountSetMembers)
		pools.POST("/account-sets/:set_id/members", h.Admin.UpstreamPool.AddAccountSetMembers)
		pools.DELETE("/account-sets/:set_id/members/:account_id", h.Admin.UpstreamPool.DeleteAccountSetMember)
		pools.PUT("/account-sets/:set_id/members/:account_id/capacity", h.Admin.UpstreamPool.UpdateAccountSetMemberCapacity)
		...
		pools.POST("/:id/members", h.Admin.UpstreamPool.CreateMember)
		pools.POST("/:id/member-sets", h.Admin.UpstreamPool.CreateMemberSet)
		pools.PUT("/members/:member_id", h.Admin.UpstreamPool.UpdateMember)
		pools.DELETE("/members/:member_id", h.Admin.UpstreamPool.DeleteMember)
		pools.PUT("/member-sets/:member_set_id", h.Admin.UpstreamPool.UpdateMemberSet)
		pools.DELETE("/member-sets/:member_set_id", h.Admin.UpstreamPool.DeleteMemberSet)
		pools.POST("/bindings", h.Admin.UpstreamPool.CreateBinding)
		pools.PUT("/bindings/:binding_id", h.Admin.UpstreamPool.UpdateBinding)
		pools.DELETE("/bindings/:binding_id", h.Admin.UpstreamPool.DeleteBinding)
	}
}
