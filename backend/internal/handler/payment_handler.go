...
func (h *PaymentHandler) GetCheckoutInfo(c *gin.Context) {
	...
	response.Success(c, checkoutInfoResponse{
		...
		RechargeCampaignEnabled:   cfg.RechargeCampaignEnabled,
		RechargeCampaignAmount:    cfg.RechargeCampaignAmount,
		RechargeCampaignBonusRate: cfg.RechargeCampaignBonusRate,
