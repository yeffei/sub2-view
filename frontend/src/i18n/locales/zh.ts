export default {
  ...
  usage: {
    ...
    cacheHitTitle: '缓存命中',
    cacheHitRequestsLabel: '命中请求 {value}',
    cacheReadPerHitLabel: '单次命中读取 {value}',
    avgActualInputTokensLabel: '平均实际输入 {value}',
    totalCost: '总消费',
    standardCost: '标准',
    actualCost: '实际',
    accountCost: '成本',
    ...
    adminLedger: {
      ...
      briefing: {
        ...
        costTitle: '用量毛利',
        costPending: '整理中',
        costNotePending: '正在整理销售额、上游成本与毛利率。',
        costValue: '$' + '{value}',
        costNote: '销售额 $' + '{revenue}，上游成本 $' + '{accountCost}，毛利率 {margin}。',
        anomalyTitle: '异常入口',
        anomalyPending: '整理中',
  ...
  channelStatus: {
    title: '上游池状态',
    description: '查看上游池可服务状态、延迟和近期波动',
    searchPlaceholder: '搜索上游池...',
    allProviders: '全部供应商',
    loadError: '加载上游池状态失败',
    detailLoadError: '加载上游池详情失败',
    detailTitle: '上游池详情',
    closeDetail: '关闭',
    windowTab: {
      '7d': '7 天',
  ...
  admin: {
    ...
    dashboard: {
	  ...
	  metricGrossProfit: '按毛利',
	  inspectNegativeMargin: '排查',
	  inspectNegativeMarginHint: '将账册筛选到该负毛利分组',
      metricCacheHitRate: '按命中率',
      metricCacheReadPerHit: '按读/次',
      tokenUsageTrend: 'Token 使用趋势',
      noDataAvailable: '暂无数据',
      model: '模型',
      group: '分组',
      ...
      spendShort: '消费',
      cacheHitRequestsShort: '命中 {value}',
      cacheHitRateShort: '命中率 {value}',
      cacheReadPerHitShort: '读/次 {value}',
      avgInputShort: '均输 {value}',
      requestsShort: '请求',
      tokensShort: 'Token',
      last7Days: '近 7 天',
      noUsageRecords: '暂无使用记录',
    ...
    channelMonitor: {
      title: '线路诊断',
      description: '管理员手工探测 endpoint / provider / model / API Key，用于排查单条线路是否可通；前台服务状态以账号探针聚合后的上游池为准。',
      searchPlaceholder: '搜索诊断项名称...',
      allProviders: '全部供应商',
      allStatus: '全部状态',
      enabledFilter: '启用状态',
      onlyEnabled: '仅启用',
      ...
      runSuccess: '检测完成',
      runFailed: '检测失败',
      apiKeyDecryptFailed: 'API Key 解密失败，请重新编辑该诊断项并填入新的 Key',
      createSuccess: '诊断项创建成功',
      updateSuccess: '诊断项更新成功',
      deleteSuccess: '诊断项删除成功',
      loadError: '加载诊断项列表失败',
      deleteConfirm: '确定要删除诊断项「{name}」吗？此操作不可撤销。',
      nameRequired: '请输入诊断项名称',
      ...
      form: {
        ...
        groupName: '分组名称',
        groupNamePlaceholder: '可选，仅作为诊断项备注；前台池状态不读取此页面',
      ...
      runResultTitle: '检测结果',
      noMonitorsYet: '暂无诊断项',
      createFirstMonitor: '创建第一个诊断项，用来手工排查单条线路是否可通',
      advanced: {
        section: '高级（可选）',
        ...
        bodyModeMerge: '合并',
        bodyModeReplace: '覆盖',
        bodyModeHintOff: '使用 adapter 默认请求体（带 challenge 校验）。',
      ...
      templateField: {
        ...
        applyHint: '选中模板后，会把模板的请求头和请求体拷贝到此诊断项（快照）。后续模板变动不自动同步。'
      },
      template: {
        manageButton: '模板管理',
        managerTitle: '请求模板管理',
        ...
        applyButton: '应用到关联诊断项',
        applyTooltip: '把当前模板配置覆盖到所有关联的诊断项上',
        applyTitle: '应用模板',
        applyConfirm: '确认应用',
        applyConfirmMessage: '将把模板「{name}」的当前配置覆盖到 {n} 个关联诊断项。诊断项本地已编辑的自定义修改会被丢弃，是否继续？',
        applySuccess: '已应用到 {n} 个诊断项',
        applyPickerTitle: '应用模板「{name}」',
        applyPickerHint: '勾选要覆盖请求头/请求体的诊断项（默认全选）。诊断项本地已编辑的自定义修改会被丢弃。',
        applyPickerEmpty: '当前模板没有关联诊断项',
        applyPickerConfirm: '应用到 {n} 个诊断项',
        selectNone: '全不选',
        selectedCount: '已选 {n} / {total}',
        deleteConfirm: '确定要删除模板「{name}」吗？{n} 个关联诊断项会解除关联但保留自己的快照继续工作。',
        associatedCount: '{n} 个关联诊断项',
    ...
    accounts: {
      ...
      dataImport: '导入',
      importChooserTitle: '选择导入方式',
      importChooserDataTitle: '导入数据文件',
      importChooserDataDesc: '导入之前导出的账号/代理 JSON 数据包，适合备份迁移。',
      importChooserOpenAICodexTitle: '导入 OpenAI OAuth / Codex',
      importChooserOpenAICodexDesc: '粘贴 Codex JSON 或 accessToken 批量创建 OpenAI OAuth 账号，导入前会先预检。',
      importChooserSafetyHint: 'OpenAI OAuth / Codex 导入会先预检，不会立即写入；正式导入后会生成批次号，便于搜索核对和回滚处理。',
      moreActions: '更多操作',
      dataActions: '数据操作',
      toolActions: '工具',
      viewColumns: '列显示',
      ...
      dataImportFiles: '文件数',
      dataImportSize: '总大小',
      dataImportMergeMode: '导入方式',
      dataImportMergeSingle: '单文件直接导入',
      dataImportMergeMultiple: '多文件合并后导入',
      dataImportSelectedFiles: '已选文件',
      dataImportAccountsCreated: '账号创建',
      dataImportProxiesCreated: '代理创建',
      dataImportProxiesReused: '代理复用',
      dataImportFailures: '失败总数',
      ...
      testAccount: '测试账号',
      syncUpstreamRateMultiplier: '同步上游倍率',
      syncUpstreamRateMultiplierSuccess: '已同步上游倍率：{rate}x',
	  syncUpstreamRateMultiplierSuccessWithChange: '已同步上游倍率：{previous}x → {rate}x',
      syncUpstreamRateMultiplierFailed: '同步上游倍率失败',
      syncUpstreamRateMultiplierRouteMissing: '后端同步倍率接口未生效，请重新部署或重启后端',
      syncAllUpstreamRates: '一键同步倍率',
      syncingAllUpstreamRates: '同步全部账号中...',
      syncAllUpstreamRatesHint: '同步全部 API Key 账号，包括未启用账号；不包含 OAuth 账号',
      syncAllUpstreamRatesConfirmTitle: '确认同步全部倍率',
      syncAllUpstreamRatesConfirmMessage: '将依次探测全部 API Key 上游账号并写入最新倍率。探测会产生少量真实上游请求，是否继续？',
      syncAllUpstreamRatesConfirm: '开始同步',
      syncAllUpstreamRatesSuccess: '已同步全部 {count} 个 API Key 账号的上游倍率',
      syncAllUpstreamRatesPartial: '一键同步完成：成功 {success} 个，失败 {failed} 个',
      retryFailedUpstreamRates: '重试失败项（{count}）',
      retryFailedUpstreamRatesSuccess: '已成功重试 {count} 个账号',
	  ...
	  upstreamRateSyncResultFailed: '失败',
	  upstreamRateSyncResultAccount: '账号',
	  upstreamRateSyncResultChange: '原倍率 → 新倍率',
	  upstreamRateSyncResultStatus: '结果',
	  upstreamRateSyncResultLargeChange: '大幅跳变，请核对',
	  upstreamRateSyncResultUpdated: '已更新',
	  upstreamRateSyncResultUnchanged: '无变化',
	  upstreamRateSyncResultUnknownAccount: '未知账号',
	  upstreamRateSyncSignificantWarning: '发现 {count} 个账号倍率大幅跳变，请查看同步结果',
      viewCostRateHistory: '查看成本倍率变化',
      costRateHistoryTitle: '{name} · 成本倍率变化',
      currentCostRate: '当前成本倍率',
      costRateHistoryTime: '同步时间',
      costRateHistoryDelta: '变化幅度',
      costRateHistorySource: '来源',
      costRateHistoryLargeChange: '大幅变化',
      costRateHistoryEmpty: '暂无成本倍率变化记录',
      costRateHistoryEmptyHint: '仅记录同步后实际发生变化的倍率。',
      costRateHistoryHint: '显示最近 30 天内仍保留的同步变化；账号成本倍率仅用于成本核算，不参与正常调度。',
      costRateHistoryLoadFailed: '加载成本倍率变化记录失败',
      scheduledCostRateSync: '自动同步成本',
      scheduledCostRateSyncHint: '开启后每天 02:00、10:00、18:00 自动同步全部 API Key 账号的成本倍率',
      scheduledCostRateSyncEnabled: '已开启自动同步成本倍率，每天执行 3 次',
      scheduledCostRateSyncDisabled: '已关闭自动同步成本倍率',
      scheduledCostRateSyncUpdateFailed: '更新自动同步成本倍率设置失败',
      searchAccounts: '搜索账号...',
      notes: '备注',
      ...
      bulkActions: {
        ...
        resetStatus: '批量重置状态',
        refreshToken: '批量刷新令牌',
        syncUpstreamRate: '同步上游倍率',
        syncingUpstreamRate: '倍率同步中...',
        resetStatusSuccess: '已成功重置 {count} 个账号状态',
        refreshTokenSuccess: '已成功刷新 {count} 个账号令牌',
        syncUpstreamRateSuccess: '已同步 {count} 个账号的上游倍率',
        syncUpstreamRatePartial: '上游倍率部分同步成功：成功 {success} 个，失败 {failed} 个',
      ...
      headerOverride: {
        ...
        emptyState: '还没有请求头条目。可以先加空行，也可以直接填入平台模板后再补值。',
        rowError: '第 {index} 行：{message}',
        entryCountHint: '已配置 {count} / {max}',
      ...
      oauth: {
        ...
        openai: {
          ...
          codexImportDefaultName: 'OpenAI Codex 导入账号',
          codexSessionDesc: '粘贴 Codex JSON 或 accessToken，按第一步配置创建账号。',
          codexSessionSafetyHint: '安全护栏：点击导入后会先做预检，不会立即写入；确认后才正式导入。正式导入会给本批账号写入批次号，误导入时可在账号列表搜索批次号后核对并批量删除。',
          codexSessionInputLabel: 'Codex JSON 或 accessToken',
          codexSessionFileSelect: '从文件导入 Codex JSON / accessToken',
          codexSessionFileHint: '支持 .json / .txt；读取后会自动填入下方文本框，仍会先预检再导入。',
          codexSessionFileReadFailed: '文件读取失败，请确认文件可访问后重试。',
          ...
          codexSessionPreviewTitle: '导入预检完成，尚未写入账号。',
          codexSessionPreviewSummary: '共 {total} 条；预计新增 {created}，更新 {updated}，跳过 {skipped}，失败 {failed}。',
          codexSessionPreviewWarnings: '预警：\n{warnings}',
          codexSessionPreviewErrors: '失败：\n{errors}',
          codexSessionPreviewFailedBlock: '存在失败项，确认后只会导入可处理的条目。',
          codexSessionPreviewConfirm: '确认继续正式导入？',
          codexSessionImportCancelled: '已取消 Codex 账号导入',
          codexSessionBatchHint: '导入批次：{batch_id}。如需撤销，可在账号列表搜索该批次号，核对后批量删除。',
      ...
      testModel: '测试模型',
      testPrompt: '提示词："hi"',
      testRequestType: '请求类型',
      testStatus: '测试状态',
      testModeHintDefault: '走常规测试链路，适合验证该账号当前的基础可用性。',
      testModeHintCompact: '仅用于 OpenAI Compact 探测，会命中 compact 端点与 compact 模型映射链路。',
    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          title: '上游池状态探针',
          description: '定期对账号发起轻量探针，并聚合为前台上游池运行状态。关闭后自动账号探针停止，用户端服务状态不再刷新。',
          configureLink: '前往 渠道管理 > 线路诊断 查看手工探针',
          enabled: '启用上游池状态探针',
          enabledHint: '关闭后后台不再执行账号级定时探针，已有历史数据保留。',
          defaultInterval: '默认检测间隔（秒）',
          defaultIntervalHint: '账号级探针的默认周期。范围 15 – 3600 秒，推荐 300 秒。',
        },
        availableChannels: {
          title: '可用渠道',
