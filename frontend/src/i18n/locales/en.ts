import officialMessages from './en/index'
...
const sstMessages = {
  ...
  usage: {
    ...
    adminLedger: {
      ...
      briefing: {
        ...
        costTitle: 'Usage Gross Profit',
        costPending: 'Pending',
        costNotePending: 'Preparing usage revenue, upstream cost, and gross margin.',
        costValue: '$' + '{value}',
        costNote: 'Revenue $' + '{revenue}, upstream cost $' + '{accountCost}, gross margin {margin}.',
		...
		actionNegativeMargin: 'Review Negative-Margin Groups',
		...
		actionNoteNegativeMargin: 'Cost exceeds usage revenue in this filter. Sort groups by gross profit to locate the source.',
        ...
        summaryCost: 'Revenue $' + '{revenue}, usage gross profit $' + '{profit} ({margin})',
		...
		summaryActionNegativeMargin: 'Sort by group gross profit to find usage sold below account cost',
        tagTokens: 'Tokens {value}',
        tagErrors: 'Errors {value}',
        tagGroups: 'Groups {value}',
        tagEndpoints: 'Endpoints {value}',
		tagNegativeMargin: 'Negative margin in current filters',
  ...
  channelStatus: {
    title: 'Upstream Pool Status',
    description: 'Inspect upstream pool health, latency, and recent changes',
    searchPlaceholder: 'Search upstream pools...',
    allProviders: 'All Providers',
    loadError: 'Failed to load upstream pool status',
    detailLoadError: 'Failed to load upstream pool detail',
    detailTitle: 'Upstream Pool Detail',
    closeDetail: 'Close',
    windowTab: {
      '7d': '7 days',
      '15d': '15 days',
    ...
    card: {
      poolRuntimeOnly: 'Pool runtime status'
    },
    capacity: {
      ample: 'Ample Margin',
      watch: 'Watch Margin',
    ...
    detailSummary: {
      ...
      capacity: 'Runtime Margin',
      recentSamplesHint: 'Latest 60 samples',
      noSamples: 'No samples yet'
    },
    detailSections: {
      members: 'Pool Members',
      lines: 'Monitor Lines',
      accountProbes: 'Account Probes',
      poolRuntime: 'Pool Runtime',
    ...
    empty: {
      title: 'No upstream pools available',
      description: 'No upstream pools have been configured for display yet.'
    }
  },
  ...
  admin: {
    ...
    dashboard: {
	  ...
	  metricGrossProfit: 'By Gross Profit',
	  inspectNegativeMargin: 'Inspect',
	  inspectNegativeMarginHint: 'Filter the ledger to this negative-margin group',
    ...
    channelMonitor: {
      ...
      description: 'Manual admin probes for endpoint / provider / model / API key troubleshooting. The user-facing service status is based on account probes aggregated into upstream pools.',
      searchPlaceholder: 'Search diagnostic name...',
      allProviders: 'All Providers',
      allStatus: 'All Status',
      enabledFilter: 'Enabled',
      onlyEnabled: 'Enabled only',
      onlyDisabled: 'Disabled only',
      createButton: 'Create Diagnostic',
      createTitle: 'Create Line Diagnostic',
      editTitle: 'Edit Line Diagnostic',
      runNow: 'Run Now',
      runSuccess: 'Check completed',
      runFailed: 'Check failed',
      apiKeyDecryptFailed: 'API Key decryption failed. Please re-edit this diagnostic with a fresh key.',
      createSuccess: 'Diagnostic created',
      updateSuccess: 'Diagnostic updated',
      deleteSuccess: 'Diagnostic deleted',
      loadError: 'Failed to load diagnostics',
      deleteConfirm: 'Are you sure you want to delete diagnostic "{name}"? This action cannot be undone.',
      nameRequired: 'Please enter a diagnostic name',
      ...
      form: {
        name: 'Name',
        namePlaceholder: 'Enter diagnostic name',
        provider: 'Platform',
        ...
        groupNamePlaceholder: 'Optional note for this diagnostic; user-facing pool status does not read this page',
      ...
      noMonitorsYet: 'No diagnostics yet',
      createFirstMonitor: 'Create the first diagnostic to manually test whether a single line is reachable',
      advanced: {
      ...
      templateField: {
        ...
        applyHint: 'Picking a template copies its headers and body to this diagnostic (snapshot). Later template edits are not auto-synced.'
      },
      template: {
        ...
        applyButton: 'Apply to diagnostics',
        applyTooltip: 'Overwrite snapshot fields on associated diagnostics',
        applyTitle: 'Apply template',
        applyConfirm: 'Apply',
        applyConfirmMessage: 'Overwrite {n} associated diagnostic(s) with the current configuration of "{name}"? Any local customizations on those diagnostics will be discarded.',
        applySuccess: 'Applied to {n} diagnostic(s)',
        applyPickerTitle: 'Apply template "{name}"',
        applyPickerHint: 'Select which diagnostics to overwrite (all selected by default). Any local customizations will be discarded.',
        applyPickerEmpty: 'No diagnostics are currently associated to this template',
        applyPickerConfirm: 'Apply to {n} diagnostic(s)',
        selectNone: 'Select none',
        selectedCount: 'Selected {n} / {total}',
        deleteConfirm: 'Delete template "{name}"? {n} associated diagnostic(s) will be disassociated but keep their current snapshot and continue running.',
        associatedCount: '{n} associated diagnostic(s)',
    ...
    accounts: {
      ...
      dataImport: 'Import',
      importChooserTitle: 'Choose Import Method',
      importChooserDataTitle: 'Import data file',
      importChooserDataDesc: 'Import a previously exported accounts/proxies JSON package. Best for backup migration.',
      importChooserOpenAICodexTitle: 'Import OpenAI OAuth / Codex',
      importChooserOpenAICodexDesc: 'Paste Codex JSON or accessToken values to create OpenAI OAuth accounts in bulk. A preview runs before writing.',
      importChooserSafetyHint: 'OpenAI OAuth / Codex import runs a preview first and writes nothing immediately. The real import generates a batch ID for search, verification, and rollback handling.',
      ...
      dataImportSize: 'Total size',
      dataImportMergeMode: 'Import mode',
      dataImportMergeSingle: 'Single file import',
      dataImportMergeMultiple: 'Merge files before import',
      dataImportSelectedFiles: 'Selected files',
      dataImportAccountsCreated: 'Accounts created',
      dataImportProxiesCreated: 'Proxies created',
      dataImportProxiesReused: 'Proxies reused',
      dataImportFailures: 'Total failures',
      ...
      syncUpstreamRateMultiplier: 'Sync upstream rate',
      syncUpstreamRateMultiplierSuccess: 'Upstream rate synced: {rate}x',
	  syncUpstreamRateMultiplierSuccessWithChange: 'Upstream rate synced: {previous}x → {rate}x',
      syncUpstreamRateMultiplierFailed: 'Failed to sync upstream rate',
      syncUpstreamRateMultiplierRouteMissing: 'Backend route for upstream rate sync is not active. Redeploy or restart the backend.',
      syncAllUpstreamRates: 'Sync All Rates',
      syncingAllUpstreamRates: 'Syncing All Accounts...',
      syncAllUpstreamRatesHint: 'Sync every API-key account, including inactive accounts; OAuth accounts are excluded',
      syncAllUpstreamRatesConfirmTitle: 'Confirm Rate Sync',
      syncAllUpstreamRatesConfirmMessage: 'This probes every API-key upstream account and saves the latest rate. Probes create a small amount of real upstream traffic. Continue?',
      syncAllUpstreamRatesConfirm: 'Start Sync',
      syncAllUpstreamRatesSuccess: 'Synced upstream rates for all {count} API-key accounts',
      syncAllUpstreamRatesPartial: 'Sync all completed: {success} succeeded, {failed} failed',
      retryFailedUpstreamRates: 'Retry Failed ({count})',
      retryFailedUpstreamRatesSuccess: 'Retried {count} account(s) successfully',
	  ...
	  upstreamRateSyncResultFailed: 'Failed',
	  upstreamRateSyncResultAccount: 'Account',
	  upstreamRateSyncResultChange: 'Previous → New',
	  upstreamRateSyncResultStatus: 'Result',
	  upstreamRateSyncResultLargeChange: 'Large change; review recommended',
	  upstreamRateSyncResultUpdated: 'Updated',
	  upstreamRateSyncResultUnchanged: 'Unchanged',
	  upstreamRateSyncResultUnknownAccount: 'Unknown account',
	  upstreamRateSyncSignificantWarning: '{count} account rate(s) changed significantly; review the sync result',
      viewCostRateHistory: 'View cost rate history',
      costRateHistoryTitle: '{name} · Cost Rate Changes',
      currentCostRate: 'Current cost rate',
      costRateHistoryTime: 'Synced at',
      costRateHistoryDelta: 'Change',
      costRateHistorySource: 'Source',
      costRateHistoryLargeChange: 'Large change',
      costRateHistoryEmpty: 'No cost rate changes yet',
      costRateHistoryEmptyHint: 'Only actual changes made by upstream sync are recorded.',
      costRateHistoryHint: 'Shows retained sync changes from the last 30 days. Account cost rates are used for cost accounting only and do not affect normal scheduling.',
      costRateHistoryLoadFailed: 'Failed to load cost rate history',
      scheduledCostRateSync: 'Auto-sync costs',
      scheduledCostRateSyncHint: 'When enabled, cost rates for all API-key accounts sync daily at 02:00, 10:00, and 18:00 Asia/Shanghai',
      scheduledCostRateSyncEnabled: 'Automatic cost rate sync enabled; runs three times daily',
      scheduledCostRateSyncDisabled: 'Automatic cost rate sync disabled',
      scheduledCostRateSyncUpdateFailed: 'Failed to update automatic cost rate sync setting',
      ...
      bulkActions: {
        ...
        refreshToken: 'Refresh Token',
        syncUpstreamRate: 'Sync Upstream Rate',
        syncingUpstreamRate: 'Syncing Rates...',
        resetStatusSuccess: 'Successfully reset {count} account(s) status',
        refreshTokenSuccess: 'Successfully refreshed {count} account(s) token',
        syncUpstreamRateSuccess: 'Synced upstream rates for {count} account(s)',
        syncUpstreamRatePartial: 'Upstream rates partially synced: {success} succeeded, {failed} failed',
      ...
      headerOverride: {
        ...
        summaryTemplate: 'Template headers',
        summaryPlatform: 'Platform',
        summaryScope: 'Accounts affected',
        ...
        emptyState: 'No header rows yet. Add an empty row first, or fill the platform template and then complete the values.',
        rowError: 'Row {index}: {message}',
        entryCountHint: 'Configured {count} / {max}',
      ...
      oauth: {
        ...
        openai: {
          ...
          codexImportDefaultName: 'OpenAI Codex imported account',
          codexSessionDesc: 'Paste Codex JSON or an accessToken. Accounts use the step 1 settings.',
          codexSessionSafetyHint: 'Safety guard: import first runs a preview and writes nothing. The real import starts only after confirmation. Imported accounts are tagged with a batch ID, so you can search the account list by that ID, verify the rows, and delete them in bulk if needed.',
          codexSessionInputLabel: 'Codex JSON or accessToken',
          codexSessionFileSelect: 'Import Codex JSON / accessToken from file',
          codexSessionFileHint: 'Supports .json / .txt. The file content fills the text box below and still runs preview before import.',
          codexSessionFileReadFailed: 'Failed to read the file. Please confirm the file is accessible and try again.',
          ...
          codexSessionPreviewTitle: 'Import preview completed. No accounts have been written yet.',
          codexSessionPreviewSummary: 'Total {total}; will create {created}, update {updated}, skip {skipped}, fail {failed}.',
          codexSessionPreviewWarnings: 'Warnings:\n{warnings}',
          codexSessionPreviewErrors: 'Errors:\n{errors}',
          codexSessionPreviewFailedBlock: 'There are failed items. Confirming will import only processable items.',
          codexSessionPreviewConfirm: 'Continue with the real import?',
          codexSessionImportCancelled: 'Codex account import cancelled',
          codexSessionBatchHint: 'Import batch: {batch_id}. To roll back, search this batch ID in the account list, verify the rows, then delete them in bulk.',
      ...
      testRequestType: 'Request type',
      testStatus: 'Test status',
      testModeHintDefault: 'Uses the standard test path and is best for validating the account’s baseline availability.',
      testModeHintCompact: 'Only for OpenAI compact probing. It exercises the compact endpoint and compact model mapping path.',
    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          title: 'Upstream Pool Status Probe',
          description: 'Periodically sends lightweight account probes and aggregates them into user-facing upstream pool status. Turning it off stops automatic account probes and freezes service status freshness.',
          configureLink: 'Open Channel Management > Line Diagnostics for manual probes',
          enabled: 'Enable upstream pool status probes',
          enabledHint: 'Disabling stops account-level scheduled probes; existing history is preserved.',
          defaultInterval: 'Default check interval (seconds)',
          defaultIntervalHint: 'Default interval for account-level probes. Range 15 – 3600, with 300 seconds recommended.',
        },
        availableChannels: {
          title: 'Available Channels',
