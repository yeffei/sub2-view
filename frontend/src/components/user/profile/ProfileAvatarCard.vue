    ...
    <div :class="props.embedded ? 'space-y-3' : 'flex flex-col gap-5 px-6 py-6 sm:flex-row sm:items-start'">
      <div
        :class="props.embedded
          ? 'flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-lg border border-[#a73a2a]/30 bg-[#a73a2a] text-xl font-bold text-[#faf7ef]'
          : 'flex h-24 w-24 shrink-0 items-center justify-center overflow-hidden rounded-lg border border-[#a73a2a]/30 bg-[#a73a2a] text-3xl font-bold text-[#faf7ef]'"
      >
        <img
