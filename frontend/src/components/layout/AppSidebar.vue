<template>
  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      <router-link
        :to="homePath"
        class="sidebar-logo flex h-9 w-9 items-center justify-center overflow-hidden rounded-zen shadow-seal transition-opacity hover:opacity-80"
      ...
      <div class="sidebar-brand" :class="{ 'sidebar-brand-collapsed': sidebarCollapsed }" :aria-hidden="sidebarCollapsed ? 'true' : 'false'">
        <router-link
          :to="homePath"
          class="sidebar-brand-title font-serif text-lg font-semibold text-zen-ink transition-opacity hover:opacity-80 dark:text-zen-paper"
          @click="handleMenuItemClick(homePath)"
        >
          {{ siteName }}
        </router-link>
...
const _RechargeSubscriptionIcon = {
  render: () =>
    h(
      'svg',
...
void [_DashboardIcon, _KeyIcon, _BatchImageIcon, _ChartIcon, _GiftIcon, _UserIcon, _UsersIcon, _FolderIcon, _ChannelIcon, _CreditCardIcon, _RechargeSubscriptionIcon, _GlobeIcon, _ServerIcon, _BellIcon, _TicketIcon, _CogIcon, _SunIcon, _MoonIcon, _ChevronDoubleLeftIcon, _OrderIcon, _OrderListIcon, _ChevronDoubleRightIcon, _SignalIcon, _ShieldIcon, _PriceTagIcon, _ChevronDownIcon]
