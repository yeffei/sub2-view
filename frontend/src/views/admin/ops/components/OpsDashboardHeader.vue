...
<template>
  <div :class="['ops-dashboard-header-shell flex flex-col gap-4 rounded-3xl bg-white shadow-sm ring-1 ring-gray-900/5 dark:bg-dark-800 dark:ring-dark-700', props.fullscreen ? 'p-8' : 'p-6']">
    <!-- Top Toolbar -->
    ...
    <div v-if="overview" class="grid grid-cols-1 gap-6 lg:grid-cols-12">
      ...
      <div :class="['ops-dashboard-health-panel rounded-2xl bg-gray-50 dark:bg-dark-900 lg:col-span-5', props.fullscreen ? 'p-6' : 'p-4']">
        <div class="grid h-full grid-cols-1 gap-6 md:grid-cols-[200px_1fr] md:items-center">
          ...
          >
            ...
            >
              <div class="ops-dashboard-diagnosis-popover rounded-xl bg-white p-4 shadow-xl ring-1 ring-black/5 dark:bg-gray-800 dark:ring-white/10">
                <h4 class="mb-3 flex items-center gap-2 border-b border-gray-100 pb-2 text-[13px] font-semibold text-gray-900 dark:border-gray-700 dark:text-white">
                ...
                <div class="space-y-3">
                  <div v-for="(item, idx) in diagnosisReport" :key="idx" class="flex gap-3">
                    ...
                    <div class="flex-1">
                      <div class="text-[11px] font-semibold text-gray-900 dark:text-white">{{ item.message }}</div>
            ...
            <div class="relative flex items-center justify-center">
              ...
              <div class="absolute flex flex-col items-center">
                <span :class="[props.fullscreen ? 'text-4xl' : 'text-2xl', 'font-bold', healthScoreClass]">
            ...
            <div class="mt-4 text-center" v-if="!props.fullscreen">
              ...
              <div class="mt-1 text-[11px] font-semibold" :class="healthScoreClass">
                {{
                  isSystemIdle
              ...
              <div>
                ...
                <div class="mt-1 flex flex-wrap items-baseline gap-x-4 gap-y-2">
                  <div class="flex items-baseline gap-1.5">
                    <span :class="[props.fullscreen ? 'text-3xl' : 'text-lg sm:text-xl', 'font-bold text-gray-900 dark:text-white']">{{ displayRealTimeQps.toFixed(1) }}</span>
                    <span :class="[props.fullscreen ? 'text-sm' : 'text-xs', 'font-semibold text-gray-500']">QPS</span>
                  </div>
                  <div class="flex items-baseline gap-1.5">
                    <span :class="[props.fullscreen ? 'text-3xl' : 'text-lg sm:text-xl', 'font-bold text-gray-900 dark:text-white']">{{ displayRealTimeTps.toFixed(1) }}</span>
      ...
      <div class="grid h-full grid-cols-1 content-center gap-4 sm:grid-cols-2 lg:col-span-7 lg:grid-cols-3">
        ...
        <div class="rounded-2xl bg-gray-50 p-4 dark:bg-dark-900" style="order: 2;">
          ...
          <div class="mt-2 text-2xl font-bold" :class="getThresholdColorClass(getSLAThresholdLevel(slaPercent))">
        ...
        <div class="rounded-2xl bg-gray-50 p-4 dark:bg-dark-900" style="order: 5;">
          ...
          <div class="mt-2 flex items-baseline gap-2">
            <div class="text-2xl font-bold" :class="getThresholdColorClass(getTTFTThresholdLevel(ttftP99Ms))">
              {{ ttftP99Ms ?? '-' }}
            </div>
            <span class="text-xs font-bold text-gray-400">ms (P99)</span>
          </div>
        ...
        <div class="rounded-2xl bg-gray-50 p-4 dark:bg-dark-900" style="order: 3;">
          ...
          <div class="mt-2 text-2xl font-bold" :class="getThresholdColorClass(getRequestErrorRateThresholdLevel(errorRatePercent))">
        ...
        <div class="rounded-2xl bg-gray-50 p-4 dark:bg-dark-900" style="order: 6;">
          ...
          <div class="mt-2 text-2xl font-bold" :class="getThresholdColorClass(getUpstreamErrorRateThresholdLevel(upstreamErrorRatePercent))">
    ...
    <div v-if="overview" class="mt-2 border-t border-gray-100 pt-4 dark:border-dark-700">
      <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
        ...
        <div class="rounded-xl bg-gray-50 p-3 dark:bg-dark-900">
          ...
          <div class="mt-1 text-base font-bold" :class="cpuPercentClass">
        ...
        <div class="rounded-xl bg-gray-50 p-3 dark:bg-dark-900">
          ...
          <div class="mt-1 text-base font-bold" :class="memPercentClass">
        ...
        <div class="rounded-xl bg-gray-50 p-3 dark:bg-dark-900">
          ...
          <div class="mt-1 text-base font-bold" :class="dbMiddleClass">
            {{ dbMiddleLabel }}
          </div>
          <div v-if="!props.fullscreen" class="mt-1 text-[10px] text-gray-500 dark:text-gray-400">
        ...
        <div class="rounded-xl bg-gray-50 p-3 dark:bg-dark-900">
          ...
          <div class="mt-1 text-base font-bold" :class="redisMiddleClass">
            {{ redisMiddleLabel }}
          </div>
          <div v-if="!props.fullscreen" class="mt-1 text-[10px] text-gray-500 dark:text-gray-400">
        ...
        <div class="rounded-xl bg-gray-50 p-3 dark:bg-dark-900">
          ...
          <div class="mt-1 text-base font-bold" :class="goroutineStatusClass">
        ...
        <div class="rounded-xl bg-gray-50 p-3 dark:bg-dark-900">
          ...
          <div class="mt-1 text-base font-bold" :class="jobsStatusClass">
            {{ jobsStatusLabel }}
          </div>
...
<style>
.dark .ops-dashboard-header-shell {
...
.dark .ops-dashboard-header-shell :is(.bg-white, .bg-white\/95, .bg-gray-50, .bg-gray-100) {
  background-color: rgba(24, 26, 21, 0.76) !important;
}

.dark .ops-dashboard-header-shell :is(.text-gray-900, .text-gray-800, .text-gray-700) {
  color: #f4efe4 !important;
}

.dark .ops-dashboard-header-shell :is(.text-gray-600, .text-gray-500, .text-gray-400) {
  color: #bdb5a8 !important;
}

.dark .ops-dashboard-header-shell :is(.border-gray-100, .border-gray-200) {
  border-color: rgba(48, 52, 43, 0.82) !important;
}

.dark .ops-dashboard-header-shell :is(.bg-gray-100, .bg-gray-200) {
  background-color: rgba(17, 19, 15, 0.82) !important;
}

.dark .ops-dashboard-header-shell :is(.bg-white, .bg-white\/95) {
  background-image:
    linear-gradient(180deg, rgba(24, 26, 21, 0.92), rgba(18, 20, 16, 0.96)) !important;
}

.dark .ops-dashboard-health-panel {
  background: rgba(22, 24, 19, 0.97) !important;
  border: 1px solid rgba(48, 52, 43, 0.82) !important;
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.02) !important;
}

.dark .ops-dashboard-diagnosis-popover {
