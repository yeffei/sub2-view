...
const allColumns = computed<Column[]>(() => {
  ...
  c.push(
    ...
    { key: 'scheduler_score', label: t('admin.accounts.columns.schedulerScore'), sortable: false, class: getAccountColumnClass('scheduler_score') },
...
const handleCreateSparkShadow = async (a: Account) => {
  try {
